...
"""
#####################
pdfdesigner.defaults
#####################

This subpackage contains constants that are used to define default settings.
...
**********
    ...
    DEFAULT_COLORS - A list of named tuples that return default colors to be
    used by PDFDesigner.
"""
